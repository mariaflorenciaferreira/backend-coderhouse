...
class Productos{
    ...
    async save(object){
        ...
        try{
            ...
            if(dataParse.length){
                await fs.promises.writeFile(this.ruta, JSON.stringify([...dataParse,{...object,codigoProducto:codigoProducto,timestamp:nuevoTS,id: dataParse[dataParse.length-1].id  + 1}],null,2))
